    ...
    <div className='lg:p-24 p-1 lg:py-4 '>
      <div className='px-2 lg:px-16 flex flex-col gap-8 text-xl'>
        <div className='flex flex-col'>
          <h1 className='font-bold text-[#000000] text-2xl'>1. Introduction</h1>
        ...
        <div className='flex flex-col'>
          <h1 className='font-bold text-[#000000] text-2xl'>2. Risk Warning</h1>
        ...
        <div className='flex flex-col'>
          <h1 className='font-bold text-[#000000] text-2xl'>3. No Investment Advice</h1>
        ...
        <div className='flex flex-col'>
          <h1 className='font-bold text-[#000000] text-2xl'>4. Age Restriction</h1>
        ...
        <div className='flex flex-col'>
          <h1 className='font-bold text-[#000000] text-2xl'>5. Limitation of Liability</h1>
        ...
        <div className='flex flex-col'>
          <h1 className='font-bold text-[#000000] text-2xl'>6. Changes to Terms of Use</h1>
