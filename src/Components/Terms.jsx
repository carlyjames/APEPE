...
>>>>>>> 5e65413 (rebased and fixed)
        ...
        <div className='flex flex-col'>
          <h1 className='font-bold text-[#964B00] text-2xl'>4. Age Restriction</h1>
        ...
        <div className='flex flex-col'>
          <h1 className='font-bold text-[#964B00] text-2xl'>5. Limitation of Liability</h1>
        ...
        <div className='flex flex-col'>
          <h1 className='font-bold text-[#964B00] text-2xl'>6. Changes to Terms of Use</h1>
